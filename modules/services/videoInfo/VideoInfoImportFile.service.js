...
class VideoDetailImportFile_Service extends Service {
    ...
    async cleanDataToStoreInDB(rows, cols) {
        ...
        await this.importDataToDB(cleanData, {
            ...dataMustCreateInDB,
    ...
    async importDataToDB(videosDetail, otherIds) {
        ...
        for (let i = 0; i < videosDetail.length; i++) {
            ...
            await this.VideoInfoService.updateCategories(videoDetail.videoFileId, { categoriesId });
            ...
            await this.VideoInfoService.updateLanguage(videoDetail, languages);
            ...
            await this.VideoInfoService.updateKeyword(videoDetail.videoFileId, { tagInput: tags });
        }
    }
