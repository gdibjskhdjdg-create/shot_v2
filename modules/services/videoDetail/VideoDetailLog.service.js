...
class VideoDetailLogService extends Service {
    constructor() {
        super(VideoDetailLog);
    }

    async getVideoDetailLogList(videoFileId, query = {}) {
    ...
    async createVideoDetailLog({ videoFileId, userId, body }) {
    ...
    async getVideoDetailLogs(filters = {}) {
        const {
            isProjectBase = false,
            projectId,
            userId,
...
module.exports = VideoDetailLogService;