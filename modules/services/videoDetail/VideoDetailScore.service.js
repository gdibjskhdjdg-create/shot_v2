...
class VideoDetailScoreService extends Service {
    ...
    async checkUserIsMainAndGetSectionKeys(user) {
        ...
        if (isMain) {
            sectionKeys = [...VideoDetailEntity.getAllSectionKeys(), 'shot-main-score']
        } else {
    ...
    async getItemsOfScore(user) {
        ...
        const allScores = VideoDetailEntity.getVideoDetailScoreList()
        const result = []
...
module.exports = VideoDetailScoreService;